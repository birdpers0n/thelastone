...
public class OffSquare : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerEnterHandler {


    private GameWorldOffline gw;
    ...
    public void DeleteInMove(float thisPos, float lastPos) {
        ...
        // sound.GameSound(3);
        gw.numOfselected--;
        gw.boxList[gw.numOfselected].GetComponent<OffSquare>().DeleteOneByOne();
